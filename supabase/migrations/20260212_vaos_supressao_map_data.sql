-- Coluna DATA (data do mapeamento) — única para mapeamento manual e mecanizado (mesmo dia)
...
-- Recriar a view para incluir as novas colunas (REPLACE não permite mudar número de colunas)
