...
Write-Host "VER LOGS DO COMANDO /START" -ForegroundColor Cyan
Write-Host "===========================================" -ForegroundColor Cyan
Write-Host ""

# Copiar script
Write-Host "Copiando script..." -ForegroundColor Yellow
scp ver_logs_start.sh "${SERVER}:/root/"
...
ssh $SERVER 'chmod +x /root/ver_logs_start.sh; /root/ver_logs_start.sh'
