...
Write-Host "VER LOGS DE VINCULACAO" -ForegroundColor Cyan
Write-Host "===========================================" -ForegroundColor Cyan
Write-Host ""

# Copiar script
Write-Host "Copiando script..." -ForegroundColor Yellow
scp ver_logs_vinculacao.sh "${SERVER}:/root/"
...
ssh $SERVER 'chmod +x /root/ver_logs_vinculacao.sh; /root/ver_logs_vinculacao.sh'
