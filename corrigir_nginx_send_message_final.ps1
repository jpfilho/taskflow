...
scp corrigir_nginx_send_message_final.sh "${SERVER}:/root/"

Write-Host ""
Write-Host "Executando correção..." -ForegroundColor Yellow
ssh $SERVER "chmod +x /root/corrigir_nginx_send_message_final.sh && /root/corrigir_nginx_send_message_final.sh"
