    ...
    switch (segment.tipoPeriodo.toUpperCase()) {
      ...
      default:
        ...
        if (isSubtask && parentTask != null) {
          ...
          print('🎨 Gantt: Subtarefa usando cor clareada da tarefa pai "${parentTask.tarefa}": ${baseColor.toString()} -> ${lightenedColor.toString()}');
        ...
        if (task.tipo.isNotEmpty) {
          ...
          if (tipoAtividade != null && tipoAtividade.corSegmento != null && tipoAtividade.corSegmento!.isNotEmpty) {
            try {
              ...
              print('🎨 Gantt: Usando cor de segmento do tipo de atividade "${task.tipo}": ${tipoAtividade.corSegmento}');
              return baseColor;
            } catch (e) {
